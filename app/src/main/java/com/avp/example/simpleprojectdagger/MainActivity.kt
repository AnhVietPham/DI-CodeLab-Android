package com.avp.example.simpleprojectdagger

import android.os.Bundle
import android.support.v7.app.AppCompatActivity
import android.support.v7.widget.LinearLayoutManager
import android.support.v7.widget.RecyclerView
import com.avp.example.daggervskoin.R.layout.activity_main
import com.avp.example.simpleprojectdagger.Application.UserApplication
...
import com.avp.example.simpleprojectdagger.features.DaggerMainActivityComponent
import com.avp.example.simpleprojectdagger.features.MainActivityModule
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initViews() {
        recyclerView = findViewById(com.avp.example.daggervskoin.R.id.recyclerView)
